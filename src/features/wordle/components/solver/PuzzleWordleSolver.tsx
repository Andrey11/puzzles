...
import PuzzleWordleRow from "../PuzzleWordleRow";
    ...
    <div className={`${styles.PuzzleDetailSolver} ${styles.DisplayContainer}`}>
      <div className={styles.ControlContainer}>
        ...
        >
          ...
          <PuzzleWordleRow guess={guess1} />
          <PuzzleWordleRow guess={guess2} />
          <PuzzleWordleRow guess={guess3} />
          <PuzzleWordleRow guess={guess4} />
          <PuzzleWordleRow guess={guess5} />
          <PuzzleWordleRow guess={guess6} />
        </div>
        <Button
